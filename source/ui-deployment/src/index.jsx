...
import { applyColorMode, applyRethinkTheme, loadDarkModePreference } from './theme';

// Rethink brand theme + persisted (or system) color mode
applyRethinkTheme();
applyColorMode(loadDarkModePreference());
